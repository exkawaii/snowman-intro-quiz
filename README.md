...
- 全152曲を共通の出題プールとして使用（グループ・ユニット曲143曲＋メンバーソロ曲9曲）
- 10問 / 20問 / カスタム / 全曲モード
...
`songs.json` は **2026-09-07** 時点のスナップショットです。グループ・ユニット143曲とメンバーソロ9曲（計152曲）について、公式曲目とApple Music / iTunes Search APIの30秒プレビューURL、ジャケット画像をまとめています。全152曲が同じ出題プールに含まれます。
